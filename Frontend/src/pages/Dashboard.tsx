  ...
  useEffect(() => {
    const fetchLatestVitals = async () => {
      try {
        ...
        console.error("Failed to fetch dashboard vitals", error);
      }
    };
  ...
  const quickCards = [
    {
      ...
      label: "Vitals",
      icon: Heart,
      preview: vitals?.heart_rate ? `${vitals.heart_rate} BPM` : "Syncing...",
      iconColor: (vitals?.heart_rate ?? 0) > 100 ? "text-rose-600" : "text-rose-500",
    },
    {
      id: "diet",
      label: "Dietitian",
